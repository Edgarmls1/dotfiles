...
install () {
    ...
    local pkg_list="7zip bash-language-server bat bemenu bemenu-wayland bluetui btop cava chhsich-nerd-font cmatrix dunst fastfetch firefox flatpak fzf gazelle-tui gopls gnome-disk-utility gnome-tweaks htop hyprland hyprlock hyprpaper hyprshot hyprsunset jdtls kitty lsd mpc mpd mpv mpvpaper nemo neovim npm noto-fonts-emoji os-prober papirus-folders-git papirus-icon-theme pavucontrol picom pokeget polybar power-profiles-daemon pyright qimgv qt5-wayland qt6ct qt6-wayland qutebrowser rmpc rust-analyzer stow ttf-hack-nerd unrar unzip xdg-desktop-portal-gtk xdg-desktop-portal-hyprland yazi waybar wget wleave zathura zathura-pdf-mupdf zellij zsh"
