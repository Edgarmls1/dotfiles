...
Write-Host -- Intel.DriverAndSupportAssistant Mozilla.Firefox Zen-Team.Zen-Browser 7zip.7zip EpicGames.EpicGamesLauncher Bitwarden.Bitwarden Flow-Launcher.Flow-Launcher StartIsBack.StartAllBack RamenSoftware.Windhawk marticliment.UniGetUI Microsoft.PowerToys Microsoft.VCRedist.2015+.x64 File-New-Project.EarTrumpet Spicetify.Spicetify Spotify.Spotify Discord.Discord Git.Git Neovim.Neovim JanDeDobbeleer.OhMyPosh Python.Python.3.10 VSCodium.VSCodium Microsoft.WSL
Stop-Process -Name explorer -Force -ErrorAction SilentlyContinue | Start-Process explorer.exe | Start-Process cmd.exe -ArgumentList '/k "winget install Intel.DriverAndSupportAssistant Mozilla.Firefox Zen-Team.Zen-Browser 7zip.7zip EpicGames.EpicGamesLauncher Bitwarden.Bitwarden Flow-Launcher.Flow-Launcher StartIsBack.StartAllBack RamenSoftware.Windhawk marticliment.UniGetUI Microsoft.PowerToys Microsoft.VCRedist.2015+.x64 File-New-Project.EarTrumpet Spicetify.Spicetify Spotify.Spotify Discord.Discord Git.Git Neovim.Neovim JanDeDobbeleer.OhMyPosh Python.Python.3.10 VSCodium.VSCodium Microsoft.WSL RiotGames.LeagueOfLegends.BR --accept-source-agreements --accept-package-agreements --force"'
